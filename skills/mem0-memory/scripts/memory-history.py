#!/usr/bin/env python3
"""
Get change history (audit trail) for a memory.
Usage: ./memory-history.py --memory-id "mem_abc123"
"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Get mem0 memory history")
