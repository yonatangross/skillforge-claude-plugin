#!/usr/bin/env python3
"""
Retrieve memory export data.
Usage: ./get-export.py --user-id "project-decisions"
"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Get mem0 memory export")
    ...
    try:
        ...
        result = client.get_memory_export(user_id=args.user_id)
