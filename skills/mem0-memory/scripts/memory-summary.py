...
Usage: ./memory-summary.py [--filters '{"user_id":"project-decisions"}']
"""
import argparse
import json
import sys
...
def main():
    parser = argparse.ArgumentParser(description="Get mem0 memory summary/statistics")
    ...
    try:
        ...
        result = client.get_summary(filters=filters if filters else None)
