...
add_header() {
  ...
  case "$ext" in
    py)
      header="# Generated by SkillForge Claude Plugin
# Created: $(date +%Y-%m-%d)
...
"
    ...
    sh)
      ...
      if [[ "$content" == "#!/"* ]]; then
        ...
        header="$shebang
# Generated by SkillForge Claude Plugin
# Created: $(date +%Y-%m-%d)
...
"
      ;;
    html|xml)
      header="<!-- Generated by SkillForge Claude Plugin - $(date +%Y-%m-%d) -->
...
# Add header if content doesn't already contain "SkillForge"
